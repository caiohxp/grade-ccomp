...
const disciplinas = {
    ...
    'icc': { nome: 'Introdução à Ciência da Computação', codigo: 'TM404', nucleo: 'programacao', ementa: 'O curso de Ciência da Computação. Linha do tempo da computação. Hardware e Software Básico. Sistemas Numéricos. Grandes áreas da computação e o mercado de trabalho.', docentes: 'A ser definido', horario: 'A ser definido' },
    ...
    'eng_soft1': { nome: 'Engenharia de Software I', codigo: 'IM866', nucleo: 'horizontal', ementa: 'Introdução aos Processos de Software. Engenharia de Requisitos. Verificação e Validação de Software. Disponibilização e Qualidade de Software.', docentes: 'A ser definido', horario: 'A ser definido' },
    ...
    'bd': { nome: 'Banco de Dados', codigo: 'TM426', nucleo: 'horizontal', prerequisitos: ['Estruturas de Dados II'], ementa: 'Modelagem Conceitual (Entidade-Relacionamento). Projeto Lógico. Normalização até a 4a Forma Normal. Algebra Relacional. Linguagem de Consulta Estruturada (SQL).', docentes: 'A ser definido', horario: 'A ser definido' },
    ...
    'opt_emp_info': { nome: 'Empreendedorismo em Informática', codigo: 'TN754', nucleo: 'especificas', prerequisitos: [], ementa: 'Teoria Geral de Sistemas. Dado, informação, conhecimento. TI nas organizações. Estruturas organizacionais. Tipologia de Sistemas de Informação.', docentes: 'A ser definido', horario: 'A ser definido' },
    ...
    'opt_eng_arq_soft': { nome: 'Arquitetura de Software', codigo: 'A definir', nucleo: 'especificas', prerequisitos: ['Modelagem e Projeto de Software', 'Engenharia de Software I'], ementa: 'Fundamentos de Projeto de Sistemas. Padrões de Projeto. Padrões Arquiteturais. Introdução ao desenvolvimento WEB. Tópicos avançados.', docentes: 'A ser definido', horario: 'A ser definido' },
    'opt_eng_redes_petri': { nome: 'Introdução à Teoria das Redes de Petri', codigo: 'TM431', nucleo: 'especificas', prerequisitos: ['Álgebra Linear I', 'Grafos e Algoritmos'], ementa: 'Introdução e conceitos básicos. Definições. Redes de Petri interpretadas. Análise de Propriedades. Redes de Petri e representação de tempo. Redes de Petri e representação de dados.', docentes: 'A ser definido', horario: 'A ser definido'},
    ...
    'opt_eng_ger_proj': { nome: 'Gerência de Projetos', codigo: 'TM419', nucleo: 'especificas', prerequisitos: ['Engenharia de Software I'], ementa: 'Projetos e Organizações. Ciclo de vida de projetos. Processos de gerência de projetos. Gerência de Projetos em normas, boas práticas e modelos de maturidade. O gerente de projetos e suas interfaces.', docentes: 'A ser definido', horario: 'A ser definido' },
    'opt_eng_med_qual_soft': { nome: 'Medição e Qualidade de Software', codigo: 'A definir', nucleo: 'especificas', prerequisitos: ['Engenharia de Software I'], ementa: 'Conceitos básicos. Processo de medição de software. Planejamento de medição. Técnicas de análise. Análise de desempenho de processos. Estimativas.', docentes: 'A ser definido', horario: 'A ser definido' },
    ...
    'opt_eng_soft_exp': { nome: 'Introdução à Engenharia de Software Experimental', codigo: 'A definir', nucleo: 'especificas', prerequisitos: [], ementa: 'Introdução. Planejamento e execução de estudos experimentais. Estudos primários. Métodos estatísticos. Revisão sistemática da literatura.', docentes: 'A ser definido', horario: 'A ser definido' },
    ...
    'opt_eng_web_sem': { nome: 'Introdução à Web Semântica', codigo: 'A definir', nucleo: 'especificas', prerequisitos: ['Banco de Dados'], ementa: 'Introdução à Web Semântica. Introdução a Dados Ligados. Modelo de 5 estrelas. Resource Description Framework (RDF). RDF Schema (RDFS). Ontologias. SPARQL Protocol and RDF Query Language.', docentes: 'A ser definido', horario: 'A ser definido' },
